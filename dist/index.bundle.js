...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony import */ var _algorithm_Hexagon__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../algorithm/Hexagon */ \"./src/algorithm/Hexagon.ts\");\n/* harmony import */ var _Camera__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Camera */ \"./src/modules/Camera.ts\");\n/* harmony import */ var _Draw__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./Draw */ \"./src/modules/Draw.ts\");\n\n\n\nvar Battle = /** @class */ (function () {\n    function Battle(board) {\n        this.board = board;\n        canvas.addEventListener('click', this.mouseClickHandler.bind(this));\n    }\n    Battle.prototype.mouseClickHandler = function (event) {\n        var mouseX = event.offsetX, mouseY = event.offsetY;\n        var x = mouseX - 200;\n        var y = mouseY - 200;\n        var hex = _algorithm_Hexagon__WEBPACK_IMPORTED_MODULE_0__[\"default\"].pixelToHex(_Camera__WEBPACK_IMPORTED_MODULE_1__[\"default\"].inCam({ x: x, y: y, size: HEX_SIZE }));\n        var _a = _algorithm_Hexagon__WEBPACK_IMPORTED_MODULE_0__[\"default\"].axialToStore(hex), r = _a.r, q = _a.q;\n        this.select = this.board[r][q];\n    };\n    Battle.prototype.render = function () {\n        var _this = this;\n        var _a;\n        (_a = this.board) === null || _a === void 0 ? void 0 : _a.map(function (row) {\n            row === null || row === void 0 ? void 0 : row.map(function (hex) {\n                var x = 200 + HEX_SIZE * (Math.sqrt(3) * hex.q + (Math.sqrt(3) / 2) * hex.r);\n                var y = 200 + HEX_SIZE * ((3 / 2) * hex.r);\n                var color = hex === _this.select ? 'red' : 'white';\n                _Draw__WEBPACK_IMPORTED_MODULE_2__[\"default\"].drawHex({ x: x, y: y, size: HEX_SIZE }, color);\n                _Draw__WEBPACK_IMPORTED_MODULE_2__[\"default\"].drawText(\"[\".concat(hex.r, \", \").concat(hex.q, \"]\"), { x: x - 25, y: y + 10 });\n            });\n        });\n    };\n    return Battle;\n}());\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (Battle);\n\n\n//# sourceURL=webpack://hexagon-board/./src/modules/Battle.ts?");
